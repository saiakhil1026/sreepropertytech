  ...
  return (
    <section id="services" ref={sectionRef} className="py-24 bg-black overflow-hidden min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Detail View Overlay */}
        {selectedService && (
          <div className="fixed inset-0 z-[100] bg-black overflow-y-auto animate-fade-in-up">
            <div className="max-w-7xl mx-auto px-6 py-12 md:py-20 relative min-h-screen flex flex-col justify-center">

              <div ref={detailRef} className="bg-white/5 border border-white/10 p-10 md:p-14 rounded-lg relative overflow-hidden mt-16 md:mt-0">
                {/* Close Button - Moved Inside Card */}
                <button
                  onClick={handleBackClick}
                  className="absolute top-6 right-6 w-10 h-10 flex items-center justify-center text-yellow-600 hover:text-yellow-500 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-full transition-all group z-50 border border-white/10"
                >
        ...
        {/* Grid View (Always Rendered underneath) */}
